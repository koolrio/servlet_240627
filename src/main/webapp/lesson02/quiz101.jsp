...
%>
	<div class="container">
		<header class="d-flex align-items-center">
			...
			<form method="get" action="/lesson02/quiz10_2.jsp">
				<div class="d-flex">
					<div class = "col-10">
						<input type="text" class="form-control col-12" name="singerName">
					</div>
					<div class="col-2">
		...
		<nav class="d-flex justify-content-center align-items-center col-6 mt-2">
			<ul class="nav nav-fill w-100">
				<li class="nav-item"><a href="#" class="nav-link text-dark">Chart</a></li>
				<li class="nav-item"><a href="#" class="nav-link text-dark">Latest</a></li>
				<li class="nav-item"><a href="#" class="nav-link text-dark">Genre</a></li>
				<li class="nav-item"><a href="#" class="nav-link text-dark">DJ</a></li>
				<li class="nav-item"><a href="#" class="nav-link text-dark">Award</a></li>
			</ul>
		</nav>
<%
