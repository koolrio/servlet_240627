	...
	<div class="container ">
			...
			<div class="col-10">
				<form method="get" action="/lesson02/quiz10.jsp">
					<div class="input-group">
						<input type="text" class="form-control col-3 ml-2" name="singerName">
						<div class="input-groupt-append">
							<input type="submit" class="btn btn-info ml-2" value="Search">			
						</div>
					</div>			
				</form>
			</div>
		...
		<section class="contents">
			<div class="d-flex border border-success p-3">
				<div><img src = "<%= target.get("thumbnail") %>" alt="music photo" height="250" width="250"></div>
				<div class="ml-3">
					...
					<div class="d-flex">
						...
						<div class="ml-4">
							<div class="font-secondary"><%= target.get("album") %></div>
							<div class="font-secondary"><%= (int)target.get("time")/60 %>:<%= (int)target.get("time")%60 %></div>
							<div class="font-secondary"><%= target.get("composer") %></div>
							<div class="font-secondary"><%= target.get("lyricist") %></div>
						</div>
					</div>
				</div>
			</div>
